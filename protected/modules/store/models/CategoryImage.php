 ...
 */
class CategoryImage extends \yupe\models\YModel
{
    /**
    ...
    {
        return [
            ['category_id, position', 'numerical', 'integerOnly' => true],
    ...
    {
        return [
            'category' => [self::BELONGS_TO, 'Store', 'category_id'],
        ];
    }
