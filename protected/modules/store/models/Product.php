...
class Product extends yupe\models\YModel implements ICommentable
{
    ...
    public function rules()
    {
        return [
            [
                'name, title, description, short_description, slug, price, discount_price, discount, data, status, is_special, info',
                'filter',
                'filter' => 'trim',
            ],
            [
            ...
            ['meta_canonical', 'url'],
            [
                'id, type_id, producer_id, sku, name, slug, price, discount_price, discount, short_description, description, data, is_special, length, height, width, weight, quantity, in_stock, status, create_time, update_time, meta_title, meta_description, meta_keywords, category_id, info',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'description' => Yii::t('StoreModule.store', 'Документы'),
            'slug' => Yii::t('StoreModule.store', 'Alias'),
            'data' => Yii::t('StoreModule.store', 'Модельный ряд'),
            ...
            'info' => Yii::t('StoreModule.store', 'Подробное описание'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('t.info', $this->info);
